...
const JOB_NAME = 'batch-local-ssd-job';
// The name of a local SSD created for this job.
const LOCAL_SSD_NAME = 'ssd-name';
...
const MACHINE_TYPE = 'c3d-standard-8-lssd';
...
async function callCreateLocalSsdJob(
  projectId,
  region,
  jobName,
  localSsdName,
