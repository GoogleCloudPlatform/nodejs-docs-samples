...
const proxysquire = require("proxysquire");
...
describe("viewTableOrViewAccessPolicy", () => {
    ...
    beforeEach(() => {
        ...
        processors.env.GOOGLE_CLOUD_PROJECT = "test-project";
        ...
        viewTableOrViewAccessPolicy = require("../src/viewTableOrViewAccessPolicy").viewTableOrViewAccessPolicy;
    });

    afterEach(() => {
        delete processors.env.GOOGLE_CLOUD_PROJECT;
        sinon.restore();
    });
