...
function createHl7v2Store (client, projectId, cloudRegion, datasetId, hl7v2StoreId) {
  ...
  client.projects.locations.datasets.hl7V2Stores.create(request)
    .then(() => {
...
function deleteHl7v2Store (client, projectId, cloudRegion, datasetId, hl7v2StoreId) {
  // Client retrieved in callback
  // getClient(serviceAccountJson, function(cb) {...});
  // const cloudRegion = 'us-central1';
  // const projectId = 'adjective-noun-123';
  // const datasetId = 'my-dataset';
  // const hl7v2StoreId = 'my-hl7v2-store';
  const hl7v2StoreName =
      `projects/${projectId}/locations/${cloudRegion}/datasets/${datasetId}/hl7V2Stores/${hl7v2StoreId}`;

  const request = {name: hl7v2StoreName};

  client.projects.locations.datasets.hl7V2Stores.delete(request)
    .then(() => {
...
function getHl7v2Store (client, projectId, cloudRegion, datasetId, hl7v2StoreId) {
  // Client retrieved in callback
  // getClient(serviceAccountJson, function(cb) {...});
  // const cloudRegion = 'us-central1';
  // const projectId = 'adjective-noun-123';
  ...
  client.projects.locations.datasets.hl7V2Stores.get(request)
    .then(results => {
...
function listHl7v2Stores (client, projectId, cloudRegion, datasetId) {
  ...
  client.projects.locations.datasets.hl7V2Stores.list(request)
    .then(results => {
...
function patchHl7v2Store (client, projectId, cloudRegion, datasetId, hl7v2StoreId, pubsubTopic) {
  // Client retrieved in callback
  // getClient(serviceAccountJson, function(cb) {...});
  // const cloudRegion = 'us-central1';
  // const projectId = 'adjective-noun-123';
  ...
  client.projects.locations.datasets.hl7V2Stores.patch(request)
    .then(results => {
      console.log(
        'Patched HL7v2 store with Cloud Pub/Sub topic', results['data']['notificationConfig']['pubsubTopic']);
    })
    .catch(err => {
      console.error(err);
    });
...
require(`yargs`) // eslint-disable-line
  ...
  .command(
    ...
    (opts) => {
      const cb = function (client) {
        createHl7v2Store(client, opts.projectId, opts.cloudRegion, opts.datasetId, opts.hl7v2StoreId);
      };
  ...
  .command(
    ...
    (opts) => {
      const cb = function (client) {
        deleteHl7v2Store(client, opts.projectId, opts.cloudRegion, opts.datasetId, opts.hl7v2StoreId);
      };
      getClient(opts.apiKey, opts.serviceAccount, cb);
    }
  )
  .command(
    ...
    (opts) => {
      const cb = function (client) {
        getHl7v2Store(client, opts.projectId, opts.cloudRegion, opts.datasetId, opts.hl7v2StoreId);
      };
      getClient(opts.apiKey, opts.serviceAccount, cb);
    }
  )
  .command(
    ...
    (opts) => {
      const cb = function (client) {
        listHl7v2Stores(client, opts.projectId, opts.cloudRegion, opts.datasetId);
      };
      getClient(opts.apiKey, opts.serviceAccount, cb);
    }
  )
  .command(
    ...
    (opts) => {
      const cb = function (client) {
        patchHl7v2Store(client, opts.projectId, opts.cloudRegion, opts.datasetId, opts.hl7v2StoreId, opts.pubsubTopic);
      };
      getClient(opts.apiKey, opts.serviceAccount, cb);
    }
  )
