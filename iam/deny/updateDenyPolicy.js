...
/**
 * Updates the deny rules and/ or its display name after policy creation.
 *
 * @param {string} projectId - ID or number of the Google Cloud project you want to use.
 * @param {string} policyId - The ID of the deny policy you want to update.
 * @param {string} etag - Etag field that identifies the policy version. The etag changes each time
 * you update the policy. Get the etag of an existing policy by performing a GetPolicy request.
 *
 */
function main(projectId, policyId, etag) {
