...
async function main(
  ...
  const keyVersionName = client.cryptoKeyVersionPath(projectId, locationId, keyRingId, cryptoKeyId, cryptoKeyVersionId);
  ...
  async function checkStateCryptoKeyVersion() {
    ...
    console.log(`Current state of key version ${keyVersion.name}: ${keyVersion.state}`)
    return keyVersion;
  }
