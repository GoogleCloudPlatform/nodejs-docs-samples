...
function listUptimeCheckConfigs (projectId, filter) {
   ...
   */
  // const projectId = 'YOUR_PROJECT_ID';
  // const filter = 'resource.type = gce_instance AND resource.label.instance_id = my-instance';
...
require(`yargs`)
  ...
  .command(
    ...
    `Lists uptime check configs, optionally filtering the results.`,
    {},
    (opts) => listUptimeCheckConfigs(opts.projectId, opts.filter || '')
  )
  .command(
    `list-ips`,
