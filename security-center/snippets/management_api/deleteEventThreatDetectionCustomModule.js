...
function main(organizationId, customModuleId, location = 'global') {
    ...
    // Build the full resource path for the event threat detection custom module to delete.
    ...
    async function deleteEventThreatDetectionCustomModule() {
        // Call the API.
        const [response] = await client.deleteEventThreatDetectionCustomModule(deleteEventThreatDetectionCustomModuleRequest);
        console.log('EventThreatDetectionCustomModule deleted successfully: %j', response);
    }
