...
function main(organizationId, customModuleId, location = 'global') {
    ...
    // Build the full resource path for the event threat detection custom module to retrieve.
    ...
    async function getEventThreatDetectionCustomModule() {
        // Call the API.
        const [response] = await client.getEventThreatDetectionCustomModule(getEventThreatDetectionCustomModuleRequest);
