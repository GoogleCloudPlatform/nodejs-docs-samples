...
async function main(instanceId, databaseId, projectId) {
  ...
  async function insertUsingDmlReturning(instanceId, databaseId) {
    ...
    try {
      ...
      console.error('Error insert using dml:', err);
    } finally {
      await database.close();
    }
  }
  await insertUsingDmlReturning(instanceId, databaseId);
